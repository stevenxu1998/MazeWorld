...
class rlalgorithm:
    ...
    def __init__(self, actions, learning_rate=0.01, reward_decay=0.9):
        ...
        self.pi_s = pd.DataFrame(columns=self.actions, dtype=np.float64)
    ...
    # def learn2(self, s, a, r, s_, d):
    #     self.check_state_exist(s_)
    #     if s_ != 'terminal':
    #         q_target2 = r + self.gamma * self.pi_s.loc[s_,].max()
    #     else:
    #         q_target2 = r  # next state is terminal
    #         self.pi_s.loc[s, a] = q_target2  # update
    #     return q_target2
